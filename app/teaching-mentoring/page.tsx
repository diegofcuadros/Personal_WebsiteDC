...
import { Presentation, BookOpen, Users, Lightbulb, Target, Globe, ChevronRight, Quote, GraduationCap, Award, type LucideIcon } from "lucide-react"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import { motion } from "framer-motion"
import { useScrollAnimation } from "@/hooks/use-scroll-animation"
import { courses, philosophyPoints, type Course, type TeachingPhilosophyIconKey } from "@/data/teaching"

const philosophyIconMap: Record<TeachingPhilosophyIconKey, LucideIcon> = {
  target: Target,
  globe: Globe,
  lightbulb: Lightbulb,
  users: Users,
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {philosophyPoints.map((point, index) => {
                const Icon = philosophyIconMap[point.icon]
      ...
      <Card className="bg-gradient-to-r from-slate-50 to-stone-50 dark:from-slate-900 dark:to-stone-900 border-0 shadow-lg">
        <CardContent className="p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Badge variant="outline" className="text-sm px-4 py-2">Data Science Roles</Badge>
          </div>
        </CardContent>
      </Card>
    </>
