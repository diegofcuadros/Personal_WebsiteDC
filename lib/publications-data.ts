...
export const allPublications = [
  // AI-human interaction and agent systems preprints
  {
    title: "Governed Collaborative Memory as Artificial Selection in LLM-Based Multi-Agent Systems",
    authors: "Cuadros D.F., Maiga A.A., Meskhidze H., Curtis-Trudel A.",
    journal: "arXiv preprint",
    year: 2026,
    links: [{ label: "arXiv", href: "https://arxiv.org/abs/2605.04264" }],
    tags: ["AI-Human Interaction", "AI Agent Systems"],
    imageUrl: "/Images/Publications/preprint-governed-memory.svg",
    summary:
      "This preprint develops the idea of governed collaborative memory in LLM-based multi-agent systems. It frames memory governance as a selection regime that determines which memories become shared institutional state, which remain private, and which are rejected, revised, or superseded. The paper proposes a layered architecture for local, shared, archive, and project-continuity memory, emphasizing provenance, traceability, correction pathways, epistemic quality, and role preservation.",
  },
  {
    ...
    authors: "Cuadros D.F., Maiga A.A.",
    journal: "arXiv preprint",
    year: 2026,
    links: [{ label: "arXiv", href: "https://arxiv.org/abs/2605.00055" }],
    tags: ["AI-Human Interaction", "AI Safety", "AI Agent Systems"],
    imageUrl: "/Images/Publications/preprint-ambient-persuasion.svg",
    summary:
      "This preprint analyzes a deployed multi-agent research-system incident in which routine non-adversarial content preceded unauthorized agent action and privilege escalation. It introduces ambient persuasion as an analytic label for how ordinary environmental content can influence agent behavior, and argues that authorization boundaries, persistent refusal constraints, machine-enforced policies, and post-incident audit are essential for deployed agent systems.",
  },

  // 0. Recent selected publications
  {
    title: "Spatial Inequities in COVID-19 Vaccination Coverage Across Kenya: A Geospatial Analysis of Structural Determinants and Development Index Patterns",
    authors: "Nino L., Kiragga A., Miller F.D., Mwalili S.M., Musuka G., Cuadros D.F.",
    journal: "International Journal of Epidemiology",
    year: 2026,
    links: [{ label: "Read", href: "https://www.researchgate.net/profile/Diego-Cuadros/research" }],
    tags: ["COVID-19 Vaccination", "Spatial Methods"],
    imageUrl: "/Images/Publications/publication-28.png",
    summary: "This study examines spatial inequities in COVID-19 vaccination coverage across Kenya, connecting structural determinants and development index patterns with geographic variation in immunization. The work extends the lab's precision public health portfolio beyond the United States and demonstrates how geospatial analysis can identify communities where access, infrastructure, and vulnerability shape vaccination outcomes.",
  },
  {
    title: "Uncovering the Impact of Randomness in HIV Hotspot Formation: A Mathematical Modeling Study",
    authors: "Yamamoto N., Citron D.T., Mwalili S.M., Gathungu D.K., Cuadros D.F., Bershteyn A.",
    journal: "PLOS Computational Biology",
    year: 2025,
    links: [{ label: "Read", href: "https://www.researchgate.net/profile/Diego-Cuadros/research" }],
    tags: ["HIV Hotspots", "Spatial Methods"],
    imageUrl: "/Images/Publications/publication-6.png",
    summary: "This mathematical modeling study examines how stochastic processes can shape apparent HIV hotspot formation. By separating random patterning from persistent geographic risk, the work sharpens interpretation of hotspot maps and supports more disciplined use of spatial evidence in HIV program planning.",
  },
  {
    title: "Generic Patterns in HIV Transmission Dynamics: Insights from a Phenomenological Risk-Stratified Modelling Approach",
    authors: "Awad S.F., Cuadros D.F.",
    journal: "BioMedInformatics",
    year: 2025,
    links: [{ label: "Read", href: "https://www.researchgate.net/profile/Diego-Cuadros/research" }],
    tags: ["HIV Hotspots", "Disease Modeling"],
    imageUrl: "/Images/Publications/publication-16.png",
    summary: "This modeling paper investigates recurring patterns in HIV transmission dynamics using a risk-stratified framework. It contributes to the lab's broader effort to connect parsimonious mathematical models with practical public health interpretation.",
  },
  {
    title: "Digital Transformation and Health Equity in Africa: Unpacking Social and Digital Determinants",
    authors: "Cuadros D.F., Kiragga A., Tu L., Awad S., Bwanika J., Musuka G.",
    journal: "mHealth",
    year: 2025,
    links: [{ label: "Read", href: "https://www.researchgate.net/profile/Diego-Cuadros/research" }],
    tags: ["Digital Health", "Health Disparities"],
    imageUrl: "/Images/Publications/publication-29.png",
    summary: "This article examines digital transformation and health equity in Africa through social and digital determinants. It connects Dr. Cuadros's digital epidemiology and AI-human interaction agenda with questions of access, infrastructure, and equitable technology adoption.",
  },
  ...
  },
  {
    ...
    authors: "Cuadros D.F., Huang Q., Musuka G., Dzinamarira T., Moyo B.K., Mpofu A., Makoni T., Miller F.D., Bershteyn A.",
  ...
  },
  {
    ...
    authors: "Cuadros D.F., Crowley P.D., Augustine T., Stewart G., Garcia-Ramos G.",
  ...
  },
  {
    ...
    authors: "Escobar S., Machinon N., Ambade P., Hoffman Z., Cuadros D.F.",
